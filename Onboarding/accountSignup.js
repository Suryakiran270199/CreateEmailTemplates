...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="und" style="font-family: arial, 'helvetica neue', helvetica, sans-serif;">
    ...
    <body data-new-gr-c-s-loaded="14.1137.0" style="width: 100%; font-family: arial, 'helvetica neue', helvetica, sans-serif; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; padding: 0; margin: 0;">
        <div dir="ltr" class="es-wrapper-color" lang="und" style="background-color: #efefef;">
            <!--[if gte mso 9]>
                            ...
                            <tr>
                                <td align="center" style="padding: 0; margin: 0;">
                                    ...
                                    >
                                        ...
                                        <tr>
                                            <td align="left" bgcolor="#ffffff" style="margin: 0; padding-bottom: 5px; padding-top: 10px; padding-left: 20px; padding-right: 20px; background-color: #ffffff;">
                                                <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <tr>
                                                        <td align="center" valign="top" style="padding: 0; margin: 0; width: 560px;">
                                                            ...
                                                            >
                                                                <tr>
                                                                    <td class="es-m-txt-c es-m-p0" align="left" style="padding: 0; margin: 0; padding-bottom: 10px; padding-top: 25px; padding-left: 30px;">
                                                                        <p
                                                                            style="
                                                                                margin: 0;
                                                                                -webkit-text-size-adjust: none;
                                        ...
                                        <tr class="es-mobile-hidden">
                                            <td class="esdev-adapt-off" align="left" bgcolor="#ffffff" style="padding: 0; margin: 0; padding-top: 5px; padding-left: 40px; background-color: #ffffff;">
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="padding: 0; margin: 0; width: 150px;">
                                                                        ...
                                                                        >
                                                                            <tr>
                                                                                <td align="left" style="padding: 0; margin: 0; padding-left: 10px;">
                                                                                    <strong><span style="font-family: tahoma, verdana, segoe, sans-serif;">Account Code&nbsp; &nbsp; &nbsp;:</span></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="padding: 0; margin: 0; width: 150px;">
                                                                        ...
                                                                        >
                                                                            <tr>
                                                                                <td align="left" style="padding: 0; margin: 0; padding-left: 10px;">
                                                                                    <strong><span style="font-family: tahoma, verdana, segoe, sans-serif;">Account URL&nbsp; &nbsp; &nbsp; &nbsp;:</span></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" style="padding: 0; margin: 0;">
                                                                                    <p
                                                                                        ...
                                                                                        "
                                                                                    >
                                                                                        <a href={{accountLoginUrl}}> {{accountLoginUrl}}</a>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                        ...
                                        <tr>
                                            <td class="es-m-p0r es-m-p0l" align="left" bgcolor="#ffffff" style="padding: 0; margin: 0; padding-top: 10px; padding-left: 20px; padding-right: 20px; background-color: #ffffff;">
                                                <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <!--[if !mso]><!-- -->
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="padding: 0; margin: 0;">
                                                                        <p
                                                                            ...
                                                                            "
                                                                        >
                                                                            <a href={{accountLoginUrl}} target="_blank"> {{accountLoginUrl}}</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                        ...
                                        <tr>
                                            <td align="left" bgcolor="#ffffff" style="padding: 0; margin: 0; padding-top: 5px; background-color: #ffffff;">
                                                <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <tr>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="padding: 5px; margin: 0;">
                                                                        <!--[if mso]>
                                                                            <a href={{accountLoginUrl}} target="_blank" hidden>
                                                                                <v:roundrect
                                                                                    xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                    xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                                    esdevVmlButton
                                                                                    href="{{accountLoginUrl}}
                                                                                    style="height: 41px; v-text-anchor: middle; width: 204px;"
                                                                                    arcsize="50%"
                                                                                    stroke="f"
                                                                                    fillcolor="#1e7bef"
                                                                                >
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            style="border-style: solid; border-color: #2cb543; background: #1e7bef; border-width: 0px; display: inline-block; border-radius: 25px; width: auto; mso-hide: all;"
                                                                        >
                                                                            <a
                                                                                href={{accountLoginUrl}}
                                                                                class="es-button es-button-1698921475135"
                                                                                target="_blank"
                                                                                style="
                                                                                    mso-style-priority: 100 !important;
                                                                                    text-decoration: none;
                                        ...
                                        <tr>
                                            <td class="esdev-adapt-off es-m-p10" align="left" bgcolor="#ffffff" style="margin: 0; padding-bottom: 15px; padding-top: 20px; padding-left: 20px; padding-right: 20px; background-color: #ffffff;">
                                                <table cellpadding="0" cellspacing="0" class="esdev-mso-table" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; width: 560px;">
                                                    <tr>
                                                        <td class="esdev-mso-td" valign="top" style="padding: 0; margin: 0;">
                                                            <table
                                                                            ...
                                                                            <tr>
                                                                                <td align="right" style="padding: 0; margin: 0; font-size: 0px;">
                                                                                    ...
                                                                                    >
                                                                                        <img
                                                                                            class="adapt-img"
                                                                                            src="https://vls-app-screenshots.s3.amazonaws.com/VLSEmailTemplateImages/google-play-store.png"
                                                                                            alt
                                                                                            style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
                                                                                            height="40"
                                                                                            width="132"
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" style="padding: 0; margin: 0; font-size: 0px;">
                                                                                    ...
                                                                                    >
                                                                                        <img
                                                                                            class="adapt-img"
                                                                                            src="https://vls-app-screenshots.s3.amazonaws.com/VLSEmailTemplateImages/apple-play-store.png"
                                                                                            alt
                                                                                            style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
                                                                                            height="40"
                                                                                            width="123"
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" style="padding: 0; margin: 0; width: 560px;">
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="margin: 0; padding-left: 5px; padding-right: 5px; padding-bottom: 10px; padding-top: 20px;">
                                                                        <p
                                                                            style="
                                                                                margin: 0;
                                                                                -webkit-text-size-adjust: none;
