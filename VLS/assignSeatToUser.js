module.exports = assignSeatToUser = `
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <tr>
                                                        <td align="center" valign="top" style="padding: 0; margin: 0; width: 560px;">
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="padding: 0; margin: 0; padding-left: 20px; padding-bottom: 25px;">
                                                                        <p
                                                                            style="
                                                                                margin: 0;
                                                                                -webkit-text-size-adjust: none;
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="padding: 5px; margin: 0;">
                                                                        <!--[if mso]>
                                                                            <a href={{vwpAccountURL}} target="_blank" hidden>
                                                                                <v:roundrect
                                                                                    xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                    xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                                    esdevVmlButton
                                                                                    href={{vwpAccountURL}}
                                                                                    style="height: 39px; v-text-anchor: middle; width: 206px;"
                                                                                    arcsize="13%"
                                                                                    stroke="f"
                                                                                    fillcolor="#2e77f2"
                                                                                >
                                                                        ...
                                                                        >
                                                                            <a
                                                                                href={{vwpAccountURL}}
                                                                                class="es-button msohide es-button-1697180921937"
                                                                                target="_blank"
                                                                                style="
                                                                                    mso-style-priority: 100 !important;
                                                                                    text-decoration: none;
