// const vwpAccountUrl = `https://${orgdetails.orgName}.${orgdetails?.tldName}/accountlogin.html`;
  module.exports = convertToOwnerVLSAdmin = `
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
    <head>
        ...
        <title>Convert to owner confirmation to VLS Admin</title>
        <!--[if (mso 16)]>
            <style type="text/css">
                a {
                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <tr>
                                                        <td valign="top" align="center" style="padding: 0; margin: 0; width: 560px;">
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="padding: 0; margin: 0; padding-top: 10px; padding-left: 10px; padding-right: 10px; font-size: 0px;">
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="left" style="margin: 0; padding-top: 10px; padding-bottom: 10px; padding-left: 30px; padding-right: 30px;">
                                                                        ...
                                                                        >
                                                                            Account URL :
                                                                            <a href="{{vwpAccountURL}}"> {{vwpAccountURL}}</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
