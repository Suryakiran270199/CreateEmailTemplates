//   const vwpAccountUrl = `https://${orgCode}/${tldName}/accountlogin.html`;

  module.exports = convertToPartnerToVlsAdmins = `
                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <tr>
                                                        <td valign="top" align="center" style="padding: 0; margin: 0; width: 560px;">
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="padding: 0; margin: 0; padding-top: 10px; padding-bottom: 20px; padding-left: 10px; padding-right: 10px; font-size: 0px;">
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="margin: 0; padding-top: 10px; padding-bottom: 10px; padding-left: 30px; padding-right: 30px;">
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            "
                                                                        >
                                                                            Account URL : <a href={{vwpAccountUrl}} > {{vwpAccountUrl}} <a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
