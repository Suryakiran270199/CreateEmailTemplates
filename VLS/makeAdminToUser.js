            ...
            >
                <tr>
                    <td valign="top" style="padding: 0; margin: 0;">
                                                                        ...
                                                                        <div class="platform-logo-container">
                                                                            ...
                                                                            >
                                                                                <img
                                                                                    src="{{platformLogo}}"
                                                                                    alt
                                                                                    style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; width: 250px; height: 90px; object-fit: contain;"
                                                                                />
                                                                            </a>
                                                                        </div>
                                                                    </td>
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="padding: 0; margin: 0; font-size: 0px;">
                                                                        <img src="{{templateLogo}}" alt style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;" width="180" height="180" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="padding: 0; margin: 0; width: 600px;">
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="margin: 0; padding-top: 5px; padding-bottom: 10px; padding-left: 10px; padding-right: 10px;">
                                                                        <h2
                                                                            ...
                                                                            "
                                                                        >
                                                                           {{accountAdminName}} {{firstRow}} {{orgName}}
                                                                        </h2>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="margin: 0; padding-left: 5px; padding-right: 5px; padding-top: 10px; padding-bottom: 10px;">
                                                                        <!--[if mso]>
                                                                            <a href="{{accountLoginUrl}}" target="_blank" hidden>
                                                                                <v:roundrect
                                                                                    ...
                                                                                    style="height: 39px; v-text-anchor: middle; width: 168px;"
                                                                                    arcsize="13%"
                                                                                    stroke="f"
                                                                                    fillcolor="#2e77f2"
                                                                                >
                        ...
                        <table
                            class="es-content es-mobile-hidden"
                            cellspacing="0"
                            cellpadding="0"
                            align="center"
                            role="none"
