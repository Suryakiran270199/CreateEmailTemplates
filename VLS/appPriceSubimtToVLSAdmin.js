  module.exports =  appPriceSubimtToVLSAdmin = `
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
    ...
    <body data-new-gr-c-s-loaded="14.1136.0" style="width: 100%; font-family: tahoma, verdana, segoe, sans-serif; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; padding: 0; margin: 0;">
                            ...
                            <tr>
                                <td align="center" style="padding: 0; margin: 0;">
                                    ...
                                    >
                                                ...
                                                <table cellspacing="0" cellpadding="0" width="100%" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <tr>
                                                        <td align="left" style="padding: 0; margin: 0; width: 600px;">
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="padding: 0; margin: 0; padding-bottom: 10px; padding-left: 15px; padding-right: 15px;">
                                                                        <h3
                                                                            style="
                                                                                margin: 0;
                                                                                line-height: 22px;
                                        ...
                                        <tr style="display:flex; flex-wrap:wrap; column-gap:20px; justify-content:center; margin:0px 20px">
                                        {{#pricingList}}
                                        <td style="margin: 0; padding-top: 15px; padding-bottom: 15px; padding-left: 0px; padding-right: 0px; background-color: #ffffff;" bgcolor="#ffffff" align="left">
                                            <!--[if mso]><table style="width:520px" cellpadding="0" cellspacing="0"><tr><td style="width:177px" valign="top"><![endif]-->
                                            <table
                                                class="es-left"
                                                cellspacing="0"
                                                cellpadding="0"
                                            ...
                                            >
                                                <tr>
                                                    <td class="es-m-p20b" align="left" style="padding: 0; margin: 0; width: 157px;">
                                                        ...
                                                        >
                                                            <tr>
                                                                <td class="es-m-txt-c" align="center" bgcolor="#cccccc" style="padding: 0; margin: 0; padding-bottom: 10px; padding-left: 10px; padding-right: 10px;">
                                                                    <h5 style="margin: 0; line-height: 120%; mso-line-height-rule: exactly; font-family: arial, 'helvetica neue', helvetica, sans-serif; color: #ffffff;" class="brand">
                                                                        <br />
                                                                    </h5>
                                                                    <h5
                                                                        style="margin: 0; line-height: 19px; mso-line-height-rule: exactly; font-family: tahoma, verdana, segoe, sans-serif; color: #000000; font-size: 16px;"
                                                                        class="brand"
                                                                    >
                                                                        {{priceName}}
                                                                    </h5>
                                                            ...
                                                            <tr>
                                                                <td align="center" style="margin: 0; padding-top: 10px; padding-bottom: 10px; padding-left: 15px; padding-right: 15px; font-size: 0;">
                                                                    <table
                                                                        border="0"
                                                                        width="100%"
                                                                        height="100%"
                                                            ...
                                                            <tr>
                                                                <td class="es-m-txt-c" align="center" style="margin: 0; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; padding-right: 10px;">
                                                                    <p
                                                                        style="
                                                                            margin: 0;
                                                                            -webkit-text-size-adjust: none;
                                                                        ...
                                                                        class="product-name"
                                                                    >
                                                                        <strong>{{freeTrial}} days free Trial</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td esdev-links-color="#ffffff" class="es-m-txt-c" width="50%" align="center" style="padding: 0; margin: 0; padding-bottom: 10px; padding-left: 10px; padding-right: 10px;">
                                                                    <h3
                                                                        style="
                                                                            margin: 0;
                                                                            line-height: 33px;
                                                                    ...
                                                                    >
                                                                        <span style="font-size: 17px;">
                                                                            <span style="font-size: 22px;"><strong>{{price}}</strong></span>{{#if currencyTypeIsINR}} ₹ {{/if}}{{#if currencyTypeIsUSD}} $ {{/if}}
                                                                        </span>
                                                                        <span style="font-size: 14px;">per</span><span style="font-size: 22px;">&nbsp;</span>
                                                                    </h3>
                                                                    <h3
                                                                        style="
                                                                            margin: 0;
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                <tr>
                                                                    <td align="center" style="padding: 5px; margin: 0;">
                                                                        <!--[if mso]>
                                                                            <a href={{vlsLoginURL}} target="_blank" hidden>
                                                                                <v:roundrect
                                                                                    xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                    xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                                    esdevVmlButton
                                                                                    href={{vlsLoginURL}}
                                                                                    style="height: 39px; v-text-anchor: middle; width: 198px;"
                                                                                    arcsize="13%"
                                                                                    stroke="f"
                                                                                    fillcolor="#2e77f2"
                                                                                >
                                                                        ...
                                                                        >
                                                                            <a
                                                                                href={{vlsLoginURL}}
                                                                                class="es-button es-button-1697696904661"
                                                                                target="_blank"
                                                                                style="
                                                                                    mso-style-priority: 100 !important;
                                                                                    text-decoration: none;
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="padding: 5px; margin: 0;">
                                                                        <a
                                                                            ...
                                                                            style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #333333; font-size: 14px;"
                                                                            href=""
                                                                        ></a>
                                                                        <p
                                                                            style="
