...
module.exports = defaultAppSubscription = `
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
    <head>
        ...
        <title>voltussprint default subscription</title>
        <!--[if (mso 16)]>
            <style type="text/css">
                a {
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="padding: 15px; margin: 0;">
                                                                        <!--[if mso]>
                                                                            <a href={{vwpLoginUrl}} target="_blank" hidden>
                                                                                <v:roundrect
                                                                                    xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                    xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                                    esdevVmlButton
                                                                                    href={{vwpLoginUrl}}
                                                                                    style="height: 41px; v-text-anchor: middle; width: 258px;"
                                                                                    arcsize="22%"
                                                                                    stroke="f"
                                                                                    fillcolor="#2e77f2"
                                                                                >
                                                                        ...
                                                                        >
                                                                            <a
                                                                                href={{vwpLoginUrl}}
                                                                                class="es-button es-button-1697446024099"
                                                                                target="_blank"
                                                                                style="
                                                                                    mso-style-priority: 100 !important;
                                                                                    text-decoration: none;
